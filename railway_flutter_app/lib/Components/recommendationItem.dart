...
class RecommendationItem extends StatelessWidget{
   ...
   const RecommendationItem({Key key, this.title, this.price, this.color}):super(key:key);
...
Widget _destination(){
  return Container(
    child: Row(
      children: <Widget>[
        Text("SFO",style: TextStyle(fontSize: 22,color: Colors.white, fontWeight: FontWeight.bold)),
        SizedBox(width: 10),
        Icon(Icons.swap_horiz,size: 32,color: Colors.white),
        SizedBox(width: 10),
        Text("OSL",style: TextStyle(fontSize: 22,color: Colors.white,fontWeight: FontWeight.bold)),
      ],
    ),
  );
}
